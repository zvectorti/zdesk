...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do zDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o zDesk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o zDesk no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao zDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao zDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o zDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [zDesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Manter o serviço do zDesk executando em segundo plano"),
        ...
        ("show_monitors_tip", ""),
        ("View Mode", ""),
        ("enter_rustdesk_passwd_tip", "Digite a senha do zDesk."),
        ("remember_rustdesk_passwd_tip", "Lembrar a senha do zDesk."),
        ("login_linux_tip", ""),
    ].iter().cloned().collect();
}
